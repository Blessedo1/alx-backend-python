...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['user_id', 'username', 'email', 'first_name', 'last_name', 'phone_number', 'password', 'created_at']
        extra_kwargs = {
...
class ConversationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Conversation
        fields = ['conversation_id', 'participants', 'participant_ids', 'messages', 'participant_count', 'created_at', 'updated_at']
        extra_kwargs = {
